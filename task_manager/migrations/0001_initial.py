    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timelogs', to='task_manager.role')),
        ...
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['user'], name='task_manage_user_id_17dafc_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['role'], name='task_manage_role_id_fb2503_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['department'], name='task_manage_departm_d41810_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['project'], name='task_manage_project_5f663f_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['section'], name='task_manage_section_0d49ff_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['building'], name='task_manage_buildin_c9253a_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['mark'], name='task_manage_mark_id_ab35b2_idx'),
        ),
        migrations.AddIndex(
            model_name='timelog',
            index=models.Index(fields=['task'], name='task_manage_task_id_794b07_idx'),
        ),
    ]
